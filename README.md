# [SOLVED] Config-Error-This-Configuration-Section-Cannot-Be-Used-At-Th
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/config-error-this-configuration-section-cannot-be-used-at-th)
>
...
Check the overrideModeDefault setting in your web.config file to ensure it's not set to 'Deny' or overridden by a location tag.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/config-error-this-configuration-section-cannot-be-used-at-th)**
